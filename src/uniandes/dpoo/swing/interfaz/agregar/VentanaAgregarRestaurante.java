...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public void agregarRestaurante()
    {
        ...
        int fila = panelMapa.getFilaSeleccionada(); // Supuesto: método del panel de mapa
        int columna = panelMapa.getFilaSeleccionada(); // Supuesto: método del panel de mapa

        ventanaPrincipal.agregarRestaurante(nombre, calificacion, columna, fila, visitado);
